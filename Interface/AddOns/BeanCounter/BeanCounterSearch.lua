--[[
	...
	Revision: $Id: BeanCounterSearch.lua 6157 2018-09-09 15:10:05Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterSearch.lua $","$Rev: 6157 $","5.1.DEV.", 'auctioneer', 'libs')
