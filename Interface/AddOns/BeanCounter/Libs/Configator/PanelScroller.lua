--[[
	PanelScroller
	Version: 8.0.6125 (SwimmingSeadragon)
	Revision: $Id: PanelScroller.lua 6125 2018-09-09 15:10:05Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/PanelScroller.lua $","$Rev: 6125 $","5.1.DEV.", 'auctioneer', 'libs')
