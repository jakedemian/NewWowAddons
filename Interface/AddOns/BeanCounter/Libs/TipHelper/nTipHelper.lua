--[[
	...
	Version: 1,4
	Revision: $Id: nTipHelper.lua 6127 2018-09-09 15:10:05Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/TipHelper/nTipHelper.lua $","$Rev: 6127 $","5.12.DEV.", 'auctioneer', 'libs')
