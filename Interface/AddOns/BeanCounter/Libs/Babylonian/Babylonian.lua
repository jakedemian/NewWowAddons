--[[
	...
	Version: 8.0.6126 (SwimmingSeadragon)
	Revision: $Id: Babylonian.lua 6126 2018-09-09 15:10:05Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Babylonian/Babylonian.lua $","$Rev: 6126 $","5.1.DEV.", 'auctioneer', 'libs')
